<div align="center">
  <br />
    <a href="https://github.com/bmwangangi" target="_blank">
...
<h3 align="center">Modern UI/UX SaaS Website</h3>
   ...
   <div align="center">
    <p>This project has been built step by step, following a detailed and structured approach. Feel free to explore the code, and we encourage you to contribute and improve it. Join the community of developers working to create innovative solutions!</p>
</div>
...
```bash
git clone https://github.com/bmwangangi/Xora-Website
cd xora
```
